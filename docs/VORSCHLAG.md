...
1. **Fotos:** Logo und Bilder der Wix-Site liegen unter `public/images/`. Für Nicole Strähl steht ein Platzhalter (`nicole-platzhalter.svg`); das echte Portrait kann später denselben Pfad ersetzen.
